...
LOGGER = logging.getLogger("connectors/csv_users")  # pylint:disable=invalid-name


class Connector(UserConnector):
    MappingName = 'JSON-assets'
    Settings = {
        'filename':   {'order': 1, 'example': "/Users/daniel/Documents/development/Oomnitza/Connector/test_data/users.csv"},
        'directory':  {'order': 2, 'example': "/Users/daniel/Documents/development/Oomnitza/Connector/test_data/users/"},
