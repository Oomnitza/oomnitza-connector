    ...
    if isinstance(mac_address, str):
        ...
        if ':' in mac_address:
            ...
            There are 4 ranges of Locally Administered Address Ranges that can be used on a local network:
                x2-xx-xx-xx-xx-xx (This covers Global Protect addresses)
                x6-xx-xx-xx-xx-xx
                xA-xx-xx-xx-xx-xx (This covers Mojo/PC address issues from https://aristanetworks.zendesk.com/agent/tickets/220767"
                xE-xx-xx-xx-xx
            """
